...
00080             self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_aad7d4675303fbdf926ded6041ae876cf}{_colors} = list()
00081             \textcolor{keywordflow}{if} (zero\_color == \textcolor{stringliteral}{""}):
00082                 self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_aad7d4675303fbdf926ded6041ae876cf}{_colors} = getGradient(color\_gradient[0], color\_gradient[1], 
      self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_a79144928881551fa1f1a18d062d761ea}{step_count})
00083             \textcolor{keywordflow}{else}:
00084                 self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_aad7d4675303fbdf926ded6041ae876cf}{_colors} = getGradient(color\_gradient[0], zero\_color, self.
      \hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_a79144928881551fa1f1a18d062d761ea}{step_count}//2+1)[:-1]
00085                 \textcolor{keywordflow}{if} (self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_a79144928881551fa1f1a18d062d761ea}{step_count}%2 == 1):
00086                     self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_aad7d4675303fbdf926ded6041ae876cf}{_colors} += [zero\_color]
00087                 self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_aad7d4675303fbdf926ded6041ae876cf}{_colors} += getGradient(zero\_color, color\_gradient[1], self.
      \hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_a79144928881551fa1f1a18d062d761ea}{step_count}//2+1)[1:]
00088         \textcolor{keywordflow}{elif} (len(color\_gradient) == step\_count-1 \textcolor{keywordflow}{and} zero\_color != \textcolor{stringliteral}{""}):
00089             self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_aad7d4675303fbdf926ded6041ae876cf}{_colors} = color\_gradient[:step\_count//2+1]
00090             \textcolor{keywordflow}{if} (step\_count%2 == 1):
00091                 self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_aad7d4675303fbdf926ded6041ae876cf}{_colors} += [zero\_color]
00092             self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_aad7d4675303fbdf926ded6041ae876cf}{_colors} += color\_gradient[step\_count//2+1:]
00093         \textcolor{keywordflow}{else}:
00094             \textcolor{keywordflow}{raise} ValueError(\textcolor{stringliteral}{"The length of 'color\_gradient' must be 2 or equal t
      o step\_count"})
00095 
00096         \textcolor{comment}{# Fraction of excluded values}
00097         \textcolor{keywordflow}{if} (isinstance(excluded, str)):
00098             \textcolor{keyword}{assert} excluded[-1] == \textcolor{stringliteral}{"%"}, \textcolor{stringliteral}{"Invalid percentage format"}
00099             self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_a826f4cfb7ebee0706db94a78c4bfe778}{_excluded} = float(excluded[:-1]) / 100
00100         \textcolor{keywordflow}{elif} (isinstance(excluded, float)):
00101             self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_a826f4cfb7ebee0706db94a78c4bfe778}{_excluded} = excluded
00102         \textcolor{keywordflow}{else}:
00103             \textcolor{keywordflow}{raise} TypeError(\textcolor{stringliteral}{"'excluded' must be a float or a str (X%)"})
00104         \textcolor{keyword}{assert} self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_a826f4cfb7ebee0706db94a78c4bfe778}{_excluded} < 1., \textcolor{stringliteral}{"Cannot exclude more than 100% of the extreme
       values"}
00105 
00106     \textcolor{keyword}{def }\_\_repr\_\_(self):
00107         rpr = \textcolor{stringliteral}{"DisplayConfig object :\(\backslash\)n"}
00108         rpr+= \textcolor{stringliteral}{"\(\backslash\)tGradient colors: "} + str(self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_aad7d4675303fbdf926ded6041ae876cf}{_colors}) + \textcolor{stringliteral}{"\(\backslash\)n"}
00109         rpr+= \textcolor{stringliteral}{"\(\backslash\)tNA color: "} + str(self.\hyperlink{classnavicom_1_1displayConfig_1_1DisplayConfig_ad8f95c1e3b29ac5622a18b7328b07f50}{na_color})
00110         \textcolor{keywordflow}{return}(rpr)
00111 
\end{DoxyCode}
